  ...
  return (
    <div className="bg-gray-100 dark:bg-gray-900 min-h-screen">
      ...
      {period === 'custom' && (
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 xl:grid-cols-4 gap-4 md:gap-6 mb-6">
          ...
          <div className="stat-card bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex flex-col justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Tempo Total <span className="text-primary-500">{getPeriodDisplayName(period)}</span></p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">{formatStudyTime(totalStudyTime)}</p>
            </div>
          ...
          <div className="stat-card bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex flex-col justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Dias em Sequência</p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">{calculateStudyStreak()}</p>
            </div>
            <div className="text-red-500 self-end">
              <FaFire className="h-5 w-5 sm:h-6 sm:w-6" />
            </div>
          </div>
          ...
          <div className="stat-card bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex flex-col justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Revisões Pendentes <span className="text-primary-500">{getPeriodDisplayName(period)}</span></p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">{countPendingReviews()}</p>
            </div>
          ...
          <div className="stat-card bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex flex-col justify-between">
            <div>
              <p className="text-xs sm:text-sm font-medium text-gray-500 dark:text-gray-400">Revisões Feitas <span className="text-primary-500">{getPeriodDisplayName(period)}</span></p>
              <p className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-white mt-1">{countCompletedReviews()}</p>
            </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
          {/* Gráfico de Pizza */}
          <div className={`bg-white dark:bg-gray-800 p-4 rounded-lg shadow-md flex flex-col h-96 ${period === 'today' ? 'lg:col-span-5' : 'lg:col-span-2'}`}>
          ...
          {/* Gráfico de Linha - Renderiza apenas se o período não for 'hoje' */}
          {period !== 'today' && (
